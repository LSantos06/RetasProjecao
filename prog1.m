...
% Objetivo: O projeto consiste em calcular pontos de fuga e verificar relações entre objetos nas imagens. 
...
for i=1:5 
    ...
    % Parte automática do programa
    title('Cálculo dos pontos (em vermelho e em verde) e reta de fuga (em magenta),')
    ...
    %% Cálculo da altura da pessoa de interesse
    ...
    %% Cálculo final da altura desejada
